...
% GAUSE: A Complete Visual and Numerical Guide
% ============================================================================
...
This appendix provides an exhaustive, self-contained walkthrough of the GAUSE algorithm. After reading this section, you will fully understand every step of the algorithm and how specialization emerges from competition.
...
The GAUSE algorithm induces specialization through three interlocking mechanisms:
...
\begin{figure}[h!]
    ...
    \end{tikzpicture}
    \caption{GAUSE algorithm flowchart. P0=Initialization, P1=Context, P2=Selection (Thompson Sampling), P3=Execution, P4=Competition (scoring), P5=Winner-only update. Blue=init, Purple=compute, Green=winner update, Red=loser path. Loop repeats $T=500$ times.}
    \label{fig:workflow}
\end{figure}
